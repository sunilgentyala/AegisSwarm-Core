...
- **Agentic Threat Tracker, ["Zero-Trust AI Governance for Multi-Agent Systems"](https://agentic-threat-tracker.com/incident/f34fe4ee00098a12515c82d359c09b4f0458a30b)** (24 July 2026): incident-tracker entry on the CSA "Securing the Swarm" analysis; names AegisSwarm directly ("The piece also introduces AegisSwarm, a proposed open-source reference implementation for zero-trust multi-agent security") and credits "Sunil Gentyala of HCLTech."
